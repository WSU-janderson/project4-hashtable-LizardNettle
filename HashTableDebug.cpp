 ...
 * I COPIED ALL TESTS HERE, BUT I DID NOT USE THIS FILE FOR TESTING I USED 'MainTest.cpp' BECAUSE I GET ERRORS
 * WHENEVER I RUN ANY CODE RELATING TO THIS PROJECT IN THIS SPECIFIC FILE, AND NOTHING I DO RESOLVES IT.
 *
 * SPENT LIKE 2 HOURS REPEATEDLY TRYING TO DELETE AND CHANGE BUILD FILES, DID NOTHING.
 */
#include <iostream>
#include "HashTable.h"
#include <cstddef>
